...
/*!
 *	@file		ImplicitConfig.h
 *	@brief		Configures the shared library aspect of the includes.
 */

#ifndef __IMPLICIT_CONFIG_H__
#define __IMPLICIT_CONFIG_H__
...
// Now set up compiler-dependent export/import symbols
  ...
  #if defined( IMPLICIT_STATICLIB )
    #define IMPLICIT_API
  #else
    #if defined( IMPLICIT_EXPORT )
