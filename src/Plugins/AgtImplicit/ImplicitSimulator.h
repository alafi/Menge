...
/*!
 *  @file       ImplicitSimulator.h
 *  @brief      Contains the Implicit::Simulator class.
 */

#ifndef __IMPLICIT_SIMULATOR_H__
#define __IMPLICIT_SIMULATOR_H__
...
/*!
 *	@namespace		Implicit
 *	@brief			The name space for the Implicit Crowds pedestrian model.
 */
namespace Implicit {
	/*!
	 *	@brief		The simulator for the Implicit pedestrian model.
	 */
	...
	public:
		 ...
		 *					Always returns false.
		 */
		virtual bool isExpTarget( const std::string & tagName ) { return tagName == "Implicit"; }
...
#endif	 // __IMPLICIT_SIMULATOR_H__
