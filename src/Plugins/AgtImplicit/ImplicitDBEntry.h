...
/*!
 *	@file		ImplicitDBEntry.h
 *	@brief		The simulator database entry for the Implicit pedestrian model.
 */

#ifndef __IMPLICIT_DB_ENTRY_H__
#define	__IMPLICIT_DB_ENTRY_H__
...
namespace Implicit {
	/*!
	 *	@brief		The simulator database entry for the Implicit simulator.
	 */
	class ImplicitDBEntry : public Menge::SimulatorDBEntry {
	public:
		/*!
